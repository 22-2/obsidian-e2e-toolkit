...
const logger$7 = loglevel.default.getLogger("constants");
/**
...
const logger$6 = loglevel.default.getLogger("ElectronAppManager");
	...
	async launchElectronApp() {
		try {
			...
			if (!(0, fs.existsSync)(distDir)) {
				...
				logger$6.error(`Electron root contents:`, await fs_promises.default.readdir(electronRoot));
