...
export class OpenVaultFeature
  implements IFeature<{ options: VaultOptions }, { page: Page; vaultPath: string }>
{
  async run(
    ...
    const vaultManager = services.getValue<VaultManager>(SERVICE_IDS.vaultManager);
